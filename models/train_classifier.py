# -*- coding: utf-8 -*-
"""
Created on Wed Dec 21 14:15:34 2022
...
def tokenize(text):
    '''
    Function uses nltk package to case normalize, lemmatize, and tokenize text.
...
def evaluate_model(model, X_test, Y_test, category_names):
    '''
    Display accuracy, precision, and recall of the tuned model for each categories.
